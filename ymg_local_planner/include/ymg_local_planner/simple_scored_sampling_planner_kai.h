#ifndef SIMPLE_SCORED_SAMPLING_PLANNER_KAI_H_
#define SIMPLE_SCORED_SAMPLING_PLANNER_KAI_H_
...
/**
 * @class SimpleScoredSamplingPlannerKai
 ...
 */
class SimpleScoredSamplingPlannerKai : public base_local_planner::TrajectorySearch {
public:

  ~SimpleScoredSamplingPlannerKai() {}
   ...
   */
  SimpleScoredSamplingPlannerKai(std::vector<TrajectorySampleGenerator*> gen_list, std::vector<TrajectoryCostFunction*>& critics, int max_samples = -1);
