...
LatchedStopRotateControllerKai::LatchedStopRotateControllerKai(const std::string& name) {
...
LatchedStopRotateControllerKai::~LatchedStopRotateControllerKai() {}
 ...
 */
bool LatchedStopRotateControllerKai::isPositionReached(LocalPlannerUtilKai* planner_util,
 ...
 * Meaning we might have overshot on the position beyond tolerance, yet still return true.
 */
bool LatchedStopRotateControllerKai::isGoalReached(LocalPlannerUtilKai* planner_util,
...
bool LatchedStopRotateControllerKai::stopWithAccLimits(const tf::Stamped<tf::Pose>& global_pose,
...
bool LatchedStopRotateControllerKai::rotateToGoal(
...
bool LatchedStopRotateControllerKai::computeVelocityCommandsStopRotate(geometry_msgs::Twist& cmd_vel,
    Eigen::Vector3f acc_lim,
    double sim_period,
